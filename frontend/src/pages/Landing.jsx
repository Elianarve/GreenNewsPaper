 ...
 return (
  ...
  {/* <main className="grid grid-cols-2 place-content-center bg-neutral-900">
      <section className="items-center mx-32 mt-20 justify-center min-h-screen bg-gray-00">
          <h1 className="font-poppins font-semibold mb-4 text-6xl text-white">¡Explora el <br/>mañana <br/><span className="text-[#FB005A]">hoy mismo!</span></h1>
          <p className='font-poppins mb-5 text-lg text-white'>Alimenta tu curiosidad diaria: <br/>tecnología, IA, blockchain y más.</p>
          <Link to="/register">
            <button className="font-poppins bg-gradient-to-r rounded-lg from-[#B800B0] to-[#FB005A] hover:from- [#FB005A] hover:to-[#FB005A] text-white py-2 px-4 focus:outline-none focus:shadow-outline mb-5 w-11/12 h-12">
              Regístrate
            </button>
          </Link>
          <Link to ="/login">
            <button className="font-poppins font-semibold bg-white rounded-lg hover:from-[#FB005A] hover:to-[#FB005A] text-black py-2 px-4 focus:outline-none focus:shadow-outline w-11/12 h-12">
              Iniciar sesión
            </button>
          </Link>
      </section>
