 ...
 return (
  ...
  <main className="grid grid-cols-2 place-content-center bg-neutral-900">
      <section className="items-center mx-32 mt-20 justify-center min-h-screen bg-gray-00">
          ...
          <button className="w-full font-poppins bg-gradient-to-r rounded-2xl from-[#B800B0] to-[#FB005A] hover:from-[#FB005A] hover:to-[#B800B0] text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline mb-5 w-11/12 h-12">
            Regístrate
          </button>
          <Link to ="/login">
          <button className="w-full font-poppins font-semibold bg-white rounded-2xl hover:from-[#FB005A] hover:to-purple-600 text-black py-2 px-4 rounded focus:outline-none focus:shadow-outline w-11/12 h-12">
            Iniciar sesión
          </button>
          </Link>
      </section>
